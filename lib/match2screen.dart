...
class Match2Screen extends StatelessWidget {
  const Match2Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('Football').doc('2_football_live').snapshots(),
